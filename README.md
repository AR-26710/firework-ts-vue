...
支持 14 种烟花类型 + 随机模式，采用插件化架构，新增类型只需在 `plugins/shells/` 目录下添加文件即可自动注册：
...
| 冠  | 日式冠型，极长寿命 + 密集金色柳型闪光，金色瀑布倾泻效果 |
| 牡丹 | 经典球形爆炸，高密度实心圆球，无拖尾纯色          |
| 锦冠 | 密集金色重闪光 + 长寿命，锦缎般效果，可附带花心/副色  |

新增烟花类型可参考开发指导文件 [`plugins/DEVELOPMENT.md`](src/simulation/plugins/DEVELOPMENT.md)。
...
| 波浪    | 从一侧向另一侧依次发射，正弦高度分布（桌面 7 发，移动 4 发） | 0.12 | —    |
| 十字爆发  | 五发呈十字形排列，中央大 + 上下左右小            | 0.15 | —    |

新增发射序列可参考开发指导文件 [`plugins/DEVELOPMENT.md`](src/simulation/plugins/DEVELOPMENT.md)。
...
- **开发指南**：详细的插件开发文档见 [`plugins/DEVELOPMENT.md`](src/simulation/plugins/DEVELOPMENT.md)
